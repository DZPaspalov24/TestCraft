...
void cellTest() {
    vector<QA> quiz = {
        ...
        {"Who is the scientist who named cells after observing cork?", "Robert Hooke"},
        {"What structure controls cell activities?", "Nucleus"},
        {"What is the jelly-like substance inside the cell?", "Cytoplasm"},
        {"What organelle produces energy for the cell?", "Mitochondria"},
        {"What organelle makes proteins?", "Ribosomes"},
        {"What organelle stores water and nutrients?", "Vacuole"},
        {"What structure performs photosynthesis in plant cells?", "Chloroplast"},
        {"What rigid outer layer protects plant cells?", "Cellwall"},
        {"What is the movement of particles from high to low concentration called?", "Diffusion"},
        {"What is the diffusion of water through a membrane called?", "Osmosis"},
        {"What type of cells have a nucleus?", "Eukaryotes"},
        {"What type of cells do not have a nucleus?", "Prokaryotes"},
        {"What is the genetic material in cells called?", "DNA"},
        {"What organelle packages proteins?", "Golgi"},
        {"What network transports materials inside the cell?", "Reticulum"},
        {"What process allows plants to make food using sunlight?", "Photosynthesis"},
        {"What organelle breaks down waste in the cell?", "Lysosome"},
        {"What process produces identical cells during division?", "Mitosis"},
        {"What microorganism type lacks a nucleus?", "Bacteria"},
        {"What organelle helps transport proteins?", "ER"},
        {"What fluid is inside plant vacuoles?", "Sap"},
        {"What structure supports the shape of animal cells?", "Cytoskeleton"},
        {"What is the study of cells called?", "Cytology"},
        {"What structure contains DNA in eukaryotic cells?", "Nucleus"},
        {"What organelle contains chlorophyll?", "Chloroplast"},
        {"What structure protects and supports plant cells?", "Cellwall"},
        {"What material inside the nucleus carries genes?", "Chromatin"},
        {"What basic unit makes up all living organisms?", "Cell"},
